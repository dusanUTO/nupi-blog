    ...
    /* @__PURE__ */ react.createElement(RelationList, { overflow }, /* @__PURE__ */ react.createElement(
      ...
      ({ data: data2, index, style }) => {
        ...
        return /* @__PURE__ */ react.createElement(
          ...
          /* @__PURE__ */ react.createElement(BoxEllipsis, { minWidth: 0, paddingTop: 1, paddingBottom: 1, paddingRight: 4 }, /* @__PURE__ */ react.createElement(Tooltip/* Tooltip */.u, { description: mainField != null ? mainField : `${id2}` }, href ? /* @__PURE__ */ react.createElement(LinkEllipsis, { to: href, disabled }, mainField != null ? mainField : id2) : /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: disabled ? "neutral600" : "primary600", ellipsis: true }, mainField != null ? mainField : id2))),
...
const EditViewDataManagerProvider = ({
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    isLoadingForData || !isCreatingEntry && !initialData.id ? /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": "true" }, /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null)) : /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
...
var useLazyComponents_defProp = Object.defineProperty;
var useLazyComponents_defProps = Object.defineProperties;
var useLazyComponents_getOwnPropDescs = Object.getOwnPropertyDescriptors;
var useLazyComponents_getOwnPropSymbols = Object.getOwnPropertySymbols;
var useLazyComponents_hasOwnProp = Object.prototype.hasOwnProperty;
var useLazyComponents_propIsEnum = Object.prototype.propertyIsEnumerable;
var useLazyComponents_defNormalProp = (obj, key, value) => key in obj ? useLazyComponents_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var useLazyComponents_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (useLazyComponents_hasOwnProp.call(b, prop))
      useLazyComponents_defNormalProp(a, prop, b[prop]);
  if (useLazyComponents_getOwnPropSymbols)
    for (var prop of useLazyComponents_getOwnPropSymbols(b)) {
      if (useLazyComponents_propIsEnum.call(b, prop))
        useLazyComponents_defNormalProp(a, prop, b[prop]);
    }
  return a;
};
var useLazyComponents_spreadProps = (a, b) => useLazyComponents_defProps(a, useLazyComponents_getOwnPropDescs(b));
...
const useLazyComponents = (componentUids) => {
  const [lazyComponentStore, setLazyComponentStore] = (0,react.useState)({});
    ...
    const lazyLoadComponents = (uids, components) => useLazyComponents_async(void 0, null, function* () {
      ...
      uids.forEach((uid, index) => {
        if (!Object.keys(lazyComponentStore).includes(uid)) {
          setLazyComponentStore(useLazyComponents_spreadProps(useLazyComponents_spreadValues({}, lazyComponentStore), { [uid]: modules[index].default }));
        }
      });
    });
